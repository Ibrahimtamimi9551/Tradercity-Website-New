    ...
    <div className="max-w-[1300px] mx-auto w-full px-6 py-6 lg:py-10 relative z-10 flex flex-col font-sans">
      ...
      <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-8 mb-10 lg:mb-12">
        ...
        <div className="w-full lg:w-[55%] flex flex-col pt-4 lg:pr-8">
          ...
          {/* Supporting Copy */}
          <div className="text-[#8F9BB3] text-[15px] leading-[1.8] space-y-4">
            <p>
        ...
        <div className="w-full lg:w-[45%] flex items-center justify-center py-6 lg:py-0">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-12 xl:gap-x-16">
          ...
          <div className="flex flex-col">
            {col0.map((feat, i) => (
              <div
                key={i}
                className={`py-6 ${i !== col0.length - 1 ? 'border-b border-white/5' : 'border-b border-white/5 md:border-b-0 lg:border-b-0'}`}
              >
          ...
          <div className="flex flex-col">
            {col1.map((feat, i) => (
              <div
                key={i}
                className={`py-6 ${i !== col1.length - 1 ? 'border-b border-white/5' : 'border-b border-white/5 lg:border-b-0'}`}
              >
                <div className="flex items-start gap-4">
                  <div
                    className="w-2 h-2 rounded-full mt-[7px] shrink-0"
