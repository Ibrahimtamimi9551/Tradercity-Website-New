...
// Herobackground Grid Resolution from Antigravity , updating whole code here 
...
//           {/* 3D Grid Lines */}
//           <div 
//             className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[250%] h-[150%] origin-bottom opacity-50"
//             style={{
...
//               // Purple on left, Cyan on right - blending smoothly into the dark center
//               background: 'linear-gradient(90deg, #9B5DE5 0%, rgba(2,3,10,0) 35%, rgba(2,3,10,0) 65%, #06D6F7 100%)',
//               WebkitMaskImage: `
//                 linear-gradient(to right, black 1px, transparent 1px),
//                 linear-gradient(to bottom, black 1px, transparent 1px)
//               `,
