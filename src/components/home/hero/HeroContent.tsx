...
export default function HeroContent() {
  return (
    ...
    <div className="relative z-10 flex flex-col items-center justify-start px-4 py-20 w-full">
  ...
  <span
    ...
    "
  >
    No One Sees The Entire Picture.
  </span>
...
{/* Supporting text */}
{/* <div className="flex flex-col items-center gap-2 text-[#CBD5E1] text-sm sm:text-base md:text-xl lg:text-2xl font-medium tracking-wide mb-6 md:mb-8">
  <p>Different traders.</p>
  <p>Different frameworks.</p>

  <p className="text-transparent bg-clip-text bg-gradient-to-r from-[#9B5DE5] via-[#0A84FF] to-[#06D6F7] font-semibold mt-2">
