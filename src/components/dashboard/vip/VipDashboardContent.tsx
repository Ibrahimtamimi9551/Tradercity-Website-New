  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-3 sm:flex-row">
        <button
          type="button"
          className="flex min-h-11 flex-1 items-center justify-center gap-2 rounded-lg border border-white/15 py-2.5 text-sm font-medium text-white/85 transition-colors hover:border-white/25 hover:bg-white/[0.04]"
        >
      ...
      <div className="grid grid-cols-1 gap-5 lg:grid-cols-3">
        <div className="rounded-xl border border-blue-500/20 bg-[#080e1c]/80 p-5">
          ...
          <div className="mb-4 flex items-center rounded-lg border border-blue-500/25 bg-[#02060f] p-1.5">
            ...
            <button
              type="button"
              className="flex min-h-11 min-w-11 items-center justify-center rounded text-white/45 transition-colors hover:bg-blue-500/20 hover:text-white"
          ...
          <div className="mb-5 flex gap-3">
            <button
              type="button"
              className="min-h-11 flex-1 rounded-lg border border-blue-500/30 py-2 text-sm font-medium text-white/75 transition-colors hover:bg-blue-500/15"
            >
              Edit Link
            </button>
            <button
              type="button"
              className="flex min-h-11 flex-1 items-center justify-center gap-1.5 rounded-lg bg-[#2563EB] py-2 text-sm font-medium text-white shadow-[0_0_18px_rgba(37,99,235,0.35)] transition-colors hover:bg-[#3B82F6]"
            >
